...
<table>
   <tr>
       <td>
            저는 단순히 기능을 만드는 것을 넘어, <br>
            사용자의 흐름을 설계하고, 구조적인 문제 해결을 주도해온 경험을 가지고 있습니다. <br>
            팀 프로젝트를 통해 기술뿐 아니라 협업과 책임감을 배웠고, <br>
            매 순간 끈기 있게 끝까지 해결해내는 힘을 키워왔습니다. <br>
       </td>
       <td>
            이름:  윤소현   <br />
            연락처: 010-4857-8428 <br />
            이메일: syeonblue@gmail.com <br />
            GIT: https://github.com/syeon279 <br />
